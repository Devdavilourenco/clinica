                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Detalhes do funcionario
                            <a data-bs-toggle="modal" data-bs-target="#exampleModal1" class="btn btn-primary float-end">Adicionar Funcionario</a>
                        </h4>
                    </div>
                    <div class="card-body table-responsive">
                        ...
                        <table class="table table-bordered table-striped" id="example" style="align-items: center;text-align: center;">
                            ...
                            <tbody style="align-items: center;text-align: center;">
                                <?php 
                                    $query = "SELECT * FROM usuario WHERE funcao = 'funcionario'";
